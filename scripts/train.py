...
if __name__ == '__main__':
    ...
    cmd1 = f'python main.py data/{train_name} --workspace model/{trial_params} -O --iters 60000 --asr_model {audio_model}'
    cmd2 = f'python main.py data/{train_name} --workspace model/{trial_params} -O --iters 100000 --finetune_lips --patch_size 64 --asr_model {audio_model}'
