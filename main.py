...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_amb', type=float, default=1e-4, help="lambda for ambient loss") # it's crucial for loss, maybe cause Nan problem.
